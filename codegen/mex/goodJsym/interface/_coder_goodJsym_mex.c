...
emlrtContext emlrtContextGlobal = { true, false, EMLRT_VERSION_INFO, NULL, "goodJsym", NULL, false, {2045744189U,2170104910U,2743257031U,4284093946U}, NULL };
...
static void goodJsym_mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  goodJsym_initialize(&emlrtContextGlobal);
...
void goodJsym_atexit_wrapper(void)
{
   goodJsym_atexit();
}
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  mexAtExit(goodJsym_atexit_wrapper);
  /* Dispatch the entry-point. */
  goodJsym_mexFunction(nlhs, plhs, nrhs, prhs);
}
/* End of code generation (_coder_goodJsym_mex.c) */
