...
MAKEFILE = goodJsym_mex.mk

include goodJsym_mex.mki
...
SRC_FILES =  \
	...
	_coder_goodJsym_mex.c \
	_coder_goodJsym_info.c

MEX_FILE_NAME_WO_EXT = goodJsym_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/goodJsym"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/goodJsym/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/goodJsym/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/goodJsym/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/goodJsym/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
