...
MAKEFILE = goodError_mex_mex.mk

include goodError_mex_mex.mki
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/goodError_mex"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/goodError_mex/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/goodError_mex/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/goodError_mex/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/goodError_mex/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
