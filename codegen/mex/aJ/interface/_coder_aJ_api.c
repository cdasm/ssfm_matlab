 ...
 * _coder_aJ_api.c
 *
 * Code generation for function '_coder_aJ_api'
 *
 */
  ...
  static const mxArray *emlrt_marshallOut(const real_T u[30])
{
  ...
  const mxArray *m0;
  static const int32_T iv1[2] = { 6, 5 };
  ...
  const emlrtMsgIdentifier *msgId))[5]
{
  ...
  void aJ_api(const mxArray * const prhs[3], const mxArray *plhs[1])
{
  real_T (*A0)[30];
  real_T (*var0)[3];
  real_T (*var1)[3];
  ...
  A0 = (real_T (*)[30])mxMalloc(sizeof(real_T [30]));
  ...
  aJ(&st, *var0, *var1, *var2, *A0);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*A0);
}

/* End of code generation (_coder_aJ_api.c) */
