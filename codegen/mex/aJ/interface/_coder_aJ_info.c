...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut("[E]/home/pitybea/ssfm_matlab/aJ.m"),
                "context", 0);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("aJ"));
...
/* End of code generation (_coder_aJ_info.c) */
