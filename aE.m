...
A0=zeros(1,6);
A0(1,1) = -p1-t155*t172*1.0/sqrt(t163+t171+(t133*t133)*t141);
A0(1,2) = -p2-t147*t172*t177;
A0(1,3) = -p3-t149*t172*t177;
A0(1,4) = q2*t28-q3*t30-t181*t190+q1*(t20-t25);
A0(1,5) = -t87+t88-t182*t190+q2*(t20-t53);
A0(1,6) = t50-t52-t178*t190+q3*(t20-t46);
